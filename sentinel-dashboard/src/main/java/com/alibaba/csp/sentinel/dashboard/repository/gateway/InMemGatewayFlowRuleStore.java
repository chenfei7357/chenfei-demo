...
import com.alibaba.csp.sentinel.dashboard.repository.metric.JpaMetricsRepository;
import com.alibaba.csp.sentinel.dashboard.repository.rule.InMemoryRuleRepositoryAdapter;
import com.alibaba.csp.sentinel.dashboard.rule.apollo.ApolloConfigUtil;
import com.alibaba.csp.sentinel.dashboard.rule.apollo.ApolloUtil;
...
public class InMemGatewayFlowRuleStore extends InMemoryRuleRepositoryAdapter<GatewayFlowRuleEntity> {
    ...
    protected long nextId() {
        return jpaMetricsRepository.getNexId("id-gateway-flow");
    }
}
